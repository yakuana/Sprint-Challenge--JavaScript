...
console.log(tyrannosaurus.period);    // -- Late Cretaceous
...
const uni = (graduates.filter(grad => grad.university.includes("Uni"))).map(graduate => graduate.university);
...
const populationTotal = zooAnimals.reduce((total, currentValue) => {return total + currentValue.population}, 0); 
